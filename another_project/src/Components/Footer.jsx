                ...
                <div className="row">
                    <div className="col-md-6 col-lg-3 mb-4 mb-lg-0">
                        ...
                        <a href="#" className="block-6">
                            <img src="assets/images/about_1.jpg"
                                alt="Image placeholder"
                                className="img-fluid rounded mb-4" />
                            <h3 className="font-weight-light  mb-0">Finding Your
                                Perfect Shirts This Summer</h3>
                    ...
                    <div className="col-md-6 col-lg-3">
                        <div className="block-5 mb-5">
                            ...
                            <ul className="list-unstyled">
                                <li className="address">203 Fake St. Mountain View,
                                    San Francisco, California, USA</li>
                                <li className="phone"><a href="tel://23923929210">+2
                                    392 3929 210</a></li>
                        ...
                        <div className="block-7">
                            <form action="#" method="post">
                                <label for="email_subscribe"
                                    className="footer-heading">Subscribe</label>
